        ...
        <div class="classify">
          <div>
            <van-tabs>
              ...
              <van-tab :title="i.name" v-for="(i,index) in  commentsDataforRider" :key="index">
...
export default {
  ...
  setup () {
    ...
    const data = reactive({
      title: 'Canteen',
      //食堂图片（最右）
      img: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fsafe-img.xhscdn.com%2Fbw1%2F52c7ea02-cc5f-4d04-8775-0477c5495024%3FimageView2%2F2%2Fw%2F1080%2Fformat%2Fjpg&refer=http%3A%2F%2Fsafe-img.xhscdn.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1704276021&t=0dd017379c635eaa5f6add9df11494dd',
      storeData: [
        {
          name: '订单发源地',
          data: {
